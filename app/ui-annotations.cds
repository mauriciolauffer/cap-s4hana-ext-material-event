using service.businessPartnerValidation.SalesService as service from '../srv/service';
...
annotate service.Addresses with @(UI: {
    ...
    DataPoint #Status: {
        Value: notification.verificationStatus,
...
annotate service.Notifications @(Capabilities: {
    Insertable: false,
    Deletable : true,
    Updatable : true,
});
